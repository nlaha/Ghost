...
module.exports = function apiRoutes() {
    ...
    router.get(
        "/galleryimages",
        mw.authAdminApi,
        http(apiCanary.galleryimages.browse)
    );
    router.post(
        "/galleryimages",
        mw.authAdminApi,
        http(apiCanary.galleryimages.add)
    );
    router.get(
        "/galleryimages/:id",
        mw.authAdminApi,
        http(apiCanary.galleryimages.read)
    );
    router.get(
        "/galleryimages/slug/:slug",
        mw.authAdminApi,
        http(apiCanary.galleryimages.read)
    );
    router.put(
        "/galleryimages/:id",
        mw.authAdminApi,
        http(apiCanary.galleryimages.edit)
    );
    router.del(
        "/galleryimages/:id",
        mw.authAdminApi,
        http(apiCanary.galleryimages.destroy)
    );
    ...
    router.get(
        "/integrations",
        mw.authAdminApi,
        http(apiCanary.integrations.browse)
    );
    router.get(
        "/integrations/:id",
        mw.authAdminApi,
        http(apiCanary.integrations.read)
    );
    router.post(
        "/integrations",
        mw.authAdminApi,
        http(apiCanary.integrations.add)
    );
    router.post(
        "/integrations/:id/api_key/:keyid/refresh",
        mw.authAdminApi,
        http(apiCanary.integrations.edit)
    );
    router.put(
        "/integrations/:id",
        mw.authAdminApi,
    ...
    router.del(
        "/integrations/:id",
        mw.authAdminApi,
        http(apiCanary.integrations.destroy)
    );
    ...
    router.put(
        ...
        http(apiCanary.schedules.publish)
    );
    ...
    router.get(
        ...
        mw.authAdminApi,
        http(apiCanary.settings.download)
    );
    router.post(
        "/settings/routes/yaml",
        mw.authAdminApi,
    ...
    router.get(
        "/settings/:key",
        mw.authAdminApi,
        http(apiCanary.settings.read)
    );
    router.put("/settings", mw.authAdminApi, http(apiCanary.settings.edit));
    router.get(
        "/settings/members/email",
        http(apiCanary.settings.validateMembersEmailUpdate)
    );
    router.post(
        "/settings/members/email",
        mw.authAdminApi,
        http(apiCanary.settings.updateMembersEmail)
    );
    router.del(
        "/settings/stripe/connect",
        mw.authAdminApi,
        http(apiCanary.settings.disconnectStripeConnectIntegration)
    );
    ...
    router.get(
        "/users/:id/token",
        mw.authAdminApi,
        http(apiCanary.users.readToken)
    );

    router.put(
        "/users/password",
        mw.authAdminApi,
        http(apiCanary.users.changePassword)
    );
    router.put(
        "/users/owner",
        mw.authAdminApi,
        http(apiCanary.users.transferOwnership)
    );
    router.put("/users/:id", mw.authAdminApi, http(apiCanary.users.edit));
    router.put(
        "/users/:id/token",
        mw.authAdminApi,
        http(apiCanary.users.regenerateToken)
    );
    ...
    router.del(
        "/members",
        mw.authAdminApi,
        http(apiCanary.members.bulkDestroy)
    );

    router.get(
        "/members/stats/count",
        mw.authAdminApi,
        http(apiCanary.members.memberStats)
    );
    router.get(
        "/members/stats/mrr",
        mw.authAdminApi,
        http(apiCanary.members.mrrStats)
    );
    router.get(
        "/members/stats/subscribers",
        mw.authAdminApi,
        http(apiCanary.members.subscriberStats)
    );
    router.get(
        "/members/stats/gross_volume",
        mw.authAdminApi,
        http(apiCanary.members.grossVolumeStats)
    );

    router.get(
        "/members/events",
        mw.authAdminApi,
        http(apiCanary.members.activityFeed)
    );

    router.get(
        "/members/upload",
        mw.authAdminApi,
        http(apiCanary.members.exportCSV)
    );
    router.post(
        "/members/upload",
        mw.authAdminApi,
    ...
    router.get(
        "/members/hasActiveStripeSubscriptions",
        mw.authAdminApi,
        http(apiCanary.members.hasActiveStripeSubscriptions)
    );

    router.get(
        "/members/stripe_connect",
        mw.authAdminApi,
        http(apiCanary.membersStripeConnect.auth)
    );
    ...
    router.del(
        "/members/:id",
        mw.authAdminApi,
        http(apiCanary.members.destroy)
    );

    router.post(
        "/members/:id/subscriptions/",
        mw.authAdminApi,
        http(apiCanary.members.createSubscription)
    );
    router.put(
        "/members/:id/subscriptions/:subscription_id",
        mw.authAdminApi,
        http(apiCanary.members.editSubscription)
    );

    router.get(
        "/members/:id/signin_urls",
        mw.authAdminApi,
        http(apiCanary.memberSigninUrls.read)
    );
    ...
    router.get(
        "/notifications",
        mw.authAdminApi,
        http(apiCanary.notifications.browse)
    );
    router.post(
        "/notifications",
        mw.authAdminApi,
        http(apiCanary.notifications.add)
    );
    router.del(
        "/notifications/:notification_id",
        mw.authAdminApi,
        http(apiCanary.notifications.destroy)
    );
    ...
    router.put(
        "/authentication/passwordreset",
        shared.middlewares.brute.globalBlock,
        http(apiCanary.authentication.resetPassword)
    );
    router.post(
        "/authentication/invitation",
        http(apiCanary.authentication.acceptInvitation)
    );
    router.get(
        "/authentication/invitation",
        http(apiCanary.authentication.isInvitation)
    );
    router.post("/authentication/setup", http(apiCanary.authentication.setup));
    router.put(
        "/authentication/setup",
        mw.authAdminApi,
        http(apiCanary.authentication.updateSetup)
    );
    ...
    router.del(
        "/invites/:id",
        mw.authAdminApi,
        http(apiCanary.invites.destroy)
    );
    ...
    router.get(
        "/redirects/download",
        mw.authAdminApi,
        http(apiCanary.redirects.download)
    );
    router.post(
        "/redirects/upload",
        mw.authAdminApi,
    ...
    router.del(
        "/webhooks/:id",
        mw.authAdminApi,
        http(apiCanary.webhooks.destroy)
    );
    ...
    // ## Email Preview
    router.get(
        "/email_preview/posts/:id",
        mw.authAdminApi,
        http(apiCanary.email_preview.read)
    );
    router.post(
        "/email_preview/posts/:id",
        mw.authAdminApi,
        http(apiCanary.email_preview.sendTestEmail)
    );
    ...
    router.del(
        "/snippets/:id",
        mw.authAdminApi,
        http(apiCanary.snippets.destroy)
    );
