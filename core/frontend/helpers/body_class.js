...
module.exports = function body_class(options) {
    ...
    const obj = this.post || this.page || this.galleryimage;
    const tags = obj && obj.tags ? obj.tags : [];
    const isPage = !!(obj && obj.page);
    const isGalleryImage = !!(obj && obj.galleryimage);
    ...
    } else if (context.includes("galleryimage") && obj && isGalleryImage) {
        classes.push("galleryimage-template");
        classes.push(`galleryimage-${obj.slug}`);
